...
def get_setup_args():
    ...
    parser.add_argument(
        "--train_url",
        type=str,
        default="https://github.com/chrischute/squad/data/train.json",
    )
    parser.add_argument(
        "--dev_url",
        type=str,
        default="https://github.com/chrischute/squad/data/dev.json",
    )
    parser.add_argument(
        "--test_url",
        type=str,
        default="https://github.com/chrischute/squad/data/test.json",
    )
    parser.add_argument(
        "--glove_url",
        type=str,
    ...
    parser.add_argument(
        "--train_record_split_size",
        type=int,
        default=5,
        help="Number of splits of the train record file.",
    )
...
def get_test_args():
    ...
    if not args.load_path:
        raise argparse.ArgumentError(
            None, message="Missing required argument --load_path"
        )
